...
class ResturantsControllerTest < ActionController::TestCase
  ...
  test "should create resturant" do
    assert_difference('Resturant.count') do
      post :create, resturant: { address: @resturant.address, name: @resturant.name, phonenumber: @resturant.phonenumber, website: @resturant.website }
    end
  ...
  test "should update resturant" do
    patch :update, id: @resturant, resturant: { address: @resturant.address, name: @resturant.name, phonenumber: @resturant.phonenumber, website: @resturant.website }
    assert_redirected_to resturant_path(assigns(:resturant))
  end
